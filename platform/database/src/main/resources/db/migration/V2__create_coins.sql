...
CREATE TABLE IF NOT EXISTS coins (
    ...
    year INT,
    era TEXT,
    confidence_country TEXT,
    confidence_denomination TEXT,
    confidence_series TEXT,
    confidence_year TEXT,
    confidence_era TEXT,
    mint_mark TEXT,
    mint_mark_status TEXT,
    mint_mark_confidence TEXT,
    ...
    supply_summary TEXT,
    demand_summary TEXT,
    value_disclaimer TEXT,
    -- Design lettering
    obverse_lettering TEXT,
    reverse_lettering TEXT,
    analysis_notes TEXT,
    obverse_visible BOOLEAN,
