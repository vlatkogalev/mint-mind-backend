...
class NumistaProvider(
    ...
    private fun NumistaTypeDetail.toCandidate(externalId: Int): CoinCatalogCandidate {
        ...
        return CoinCatalogCandidate(
            ...
            weightGrams = weight,
            diameterMm = size,
            obverseDescription = htmlToPlainText(obverse?.description),
            reverseDescription = htmlToPlainText(reverse?.description),
            historicalContext = htmlToPlainText(comments),
            ...
            edgeDescription = htmlToPlainText(edge?.description),
