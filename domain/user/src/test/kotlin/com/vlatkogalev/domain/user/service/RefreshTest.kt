...
class RefreshTest : UserAuthServiceTestBase() {
    @Test
    fun refresh_withMalformedToken_noColon_returnsFailure() = runTest {
    ...
    @Test
    fun refresh_withMalformedToken_invalidUUID_returnsFailure() = runTest {
    ...
    @Test
    fun refresh_withMalformedToken_emptyRawPart_returnsFailure() = runTest {
    ...
    @Test
    fun refresh_withUnknownUserId_returnsFailure() = runTest {
    ...
    @Test
    fun refresh_withNoStoredTokenHash_returnsFailure() = runTest {
    ...
    @Test
    fun refresh_withTamperedToken_returnsFailure() = runTest {
        val user = verifiedUser()
    ...
    @Test
    fun refresh_success_returnsNewLoginSession() = runTest {
        val user = verifiedUser()
    ...
    @Test
    fun refresh_success_rotatesRefreshToken() = runTest {
        verifiedUser()
        val loginSession = assertSuccess(service.login(TestFixtures.VALID_EMAIL, TestFixtures.VALID_PASSWORD)).value
    ...
    @Test
    fun refresh_success_updatesStoredHash() = runTest {
        val user = verifiedUser()
        val loginSession = assertSuccess(service.login(TestFixtures.VALID_EMAIL, TestFixtures.VALID_PASSWORD)).value
    ...
    @Test
    fun refresh_success_oldTokenRejectedAfterRotation() = runTest {
        verifiedUser()
        val loginSession = assertSuccess(service.login(TestFixtures.VALID_EMAIL, TestFixtures.VALID_PASSWORD)).value
    ...
    @Test
    fun refresh_withRepositoryException_returnsFailure() = runTest {
        val user = verifiedUser()
