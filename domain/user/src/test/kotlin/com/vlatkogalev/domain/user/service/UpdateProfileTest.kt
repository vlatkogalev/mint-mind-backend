...
class UpdateProfileTest : UserAuthServiceTestBase() {
    @Test
    fun updateProfile_withBlankFirstName_returnsFailure() = runTest {
    ...
    @Test
    fun updateProfile_withFirstNameOver50Chars_returnsFailure() = runTest {
    ...
    @Test
    fun updateProfile_withBlankLastName_returnsFailure() = runTest {
    ...
    @Test
    fun updateProfile_withLastNameOver50Chars_returnsFailure() = runTest {
    ...
    @Test
    fun updateProfile_withUnknownUserId_returnsFailure() = runTest {
    ...
    @Test
    fun updateProfile_success_returnsUpdatedUser() = runTest {
    ...
    @Test
    fun updateProfile_success_trimsWhitespace() = runTest {
        val user = verifiedUser()
    ...
    @Test
    fun updateProfile_withRepositoryException_returnsFailure() = runTest {
        val user = verifiedUser()
